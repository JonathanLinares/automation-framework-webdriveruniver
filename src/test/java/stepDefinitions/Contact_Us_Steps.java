...
public class Contact_Us_Steps {
    ...
    public void i_enter_a_unique_first_name() {
        driver.findElement(By.xpath("//form[@id='contact_form']/input[@name='first_name']")).sendKeys("AutoFN" + generateRandomNumber(5));
    }

    @And("I enter a unique last name")
    public void i_enter_a_unique_last_name() {
        driver.findElement(By.xpath("//form[@id='contact_form']/input[@name='last_name']")).sendKeys("AutoLN" + generateRandomNumber(5));
    ...
    public void i_enter_a_unique_comment() {
        driver.findElement(By.xpath("//form[@id='contact_form']/textarea[@name='message']")).sendKeys("This is a test " + generateRandomString(20));
    }
